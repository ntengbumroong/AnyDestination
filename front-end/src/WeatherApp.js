...
class Weather extends Component {
    ...
    handleSubmit = (event) => {
        ...
        axios.get(`https://anydestination.onrender.com/weatherRequest?loc=${this.state.location}`).then(async response => {
            console.log(response);
            if (response.data !== "Error") {
                
                const usResponse =  await axios.get(`https://anydestination.onrender.com/imgRequest?img=${this.state.location}`);
